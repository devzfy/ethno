...
целей`,
    },
    {
      ...
      answer: `Курс по Международной логистики рассчитан на 1 месяц обучения . Курс по
Американской логистики рассчитан на 1.5 месяца . Курс по Таможенному делу и ВЭД (
Декларация ) длится 1.5. Занятия проводятся по 3 раза в неделю. Мы специально
...
8\x0810 наших студентов устраиваются на работу уже во время обучения`,
    },
  ];
